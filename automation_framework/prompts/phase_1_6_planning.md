...
Write your analysis to: `{outputs_dir}/001_context_analysis.md`
...
Write to: `{outputs_dir}/002_solution_plan.md`
...
- `{outputs_dir}/002_solution_plan.md`

Write to: `{outputs_dir}/003_plan_deduplicated.md`
...
Write to: `{outputs_dir}/004_hypotheses.md`
...
Write to: `{outputs_dir}/005_search_strategy.md`
...
- `{outputs_dir}/005_search_strategy.md`

Write to: `{outputs_dir}/006_search_deduplicated.md`
